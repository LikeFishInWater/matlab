...
[qAry_cpp, TABLE_MULTIPLY_cpp, TABLE_ADD_cpp, TABLE_INVERSE_cpp, maxVarDegree_cpp, maxChkDegree_cpp, VarDegree_cpp, ChkDegree_cpp, ...
    ...
    Rate_cpp] =Initial_CPP('./matrix/BM.N14.M8.Z209.C50.G10.tcj.2.scale.2.tanner.GF.16.txt', './matrix/Arith.Table.GF.16.txt'); %Initial_CPP('./matrix/PEG.1334.GF.64.txt', './matrix/TABLE.GF64.txt');

%% Initial NBLDPC
NonBinaryFileName ='./matrix/BM.N14.M8.Z209.C50.G10.tcj.2.scale.2.tanner.GF.16.txt';
global qAry
qAry =16;
