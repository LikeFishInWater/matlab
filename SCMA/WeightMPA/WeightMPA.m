...
%                 end
                ...
                for i=1:4                    
                    for j=1:64
                        a(1)=mod(j-1,4);
                        a(2)=mod(floor((j-1)/4),4);
                        a(3)=floor(floor((j-1)/4)/4);
                        a=a+1;
                        P(i,j)=exp(-(abs(y(i)-S(i,h(i,1),a(1))-S(i,h(i,2),a(2))-S(i,h(i,3),a(3))))^2/2/sigma^2);                        
                    end
                    temp=sum(P(i,:));
                    P(i,:)=P(i,:)/temp;
                    [m,n]=sort(P(i,:),'descend');
                    WP(i,n(1:4))=P(i,n(1:4))*0.4;
                    WP(i,n(5:12))=P(i,n(5:12))*0.3;
                    WP(i,n(13:28))=P(i,n(13:28))*0.2;
                    WP(i,n(29:64))=P(i,n(29:64))*0.1;
                    temp=sum(WP(i,:));
                    WP(i,:)=WP(i,:)/temp;                   
                end   
                for i=1:4                   
                    for j=1:64
                        ...
                        a(3)=floor(floor((j-1)/4)/4);
                        a=a+1;
                        RP(i,h(i,1),a(1))=RP(i,h(i,1),a(1))+WP(i,j);
                        RP(i,h(i,2),a(2))=RP(i,h(i,2),a(2))+WP(i,j);
                        RP(i,h(i,3),a(3))=RP(i,h(i,3),a(3))+WP(i,j);
                    end
                end
                De=zeros(1,J,M); 
                for j=1:6
                    for m=1:M
                        De(1,j,m)=RP(v(1,j),j,m)*RP(v(2,j),j,m);
                    end
